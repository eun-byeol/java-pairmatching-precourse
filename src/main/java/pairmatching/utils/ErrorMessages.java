...
public class ErrorMessages {
    ...
    public static final String REMATCHING_COMMAND_NOT_OPTIONS = ERROR_TAG + "네, 아니오 중 하나의 단어야야 합니다.";
    public static final String MATCHING_FAIL = ERROR_TAG + "3회 이상 매칭이 되지 않거나 매칭을 할 수 있는 경우의 수가 없습니다.";
    public static final String NO_MATCHING_HISTORY = ERROR_TAG + "매칭 이력이 없습니다.";
}
